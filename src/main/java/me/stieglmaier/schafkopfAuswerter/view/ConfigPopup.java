...
public class ConfigPopup extends JPanel {
  ...
  private void initialize() {
    ...
    pricePaneOuter.add(new JSeparator(SwingConstants.VERTICAL), BorderLayout.EAST);
  ...
  private JPanel createPricePanel() {
    ...
    gbl_pricePaneInner.columnWeights = new double[] {0.0, 0.0, 1.0, Double.MIN_VALUE};
